...
const OrdersTable = ({ ordersByUserEmail = false }) => {
  ...
  const handleOrder = async (orderId: undefined, orderStatus: string | Blob) => {
    //delete order
                      ...
                      (
                        order: {
                          ...
                          orderId:
                            ...
                            | ReactFragment
                            | ReactPortal
                          paymentData: { paymentSource: string }
                          orderStatus: string
                        },
                        idx: number
                      ) => (
                          ...
                          <td className='px-1 py-2 min-w-[30rem]'>
                            ...
                            <div className='max-h-screen overflow-hidden transition-all duration-300 ordered-items'>
                              {order?.orderItems?.map(
                                (item: {
                                  cItemId: Key
                                  cImg: { foodImgDisplayPath: string }[]
                                  cHeading:
                                    | string
                                    | number
                                    | boolean
                                      ...
                                      <div className='flex flex-col gap-6'>
                                        ...
                                        {item?.cToppings?.map(
                                          ({
                                            ...
                                            inSeletedToppings[idx]?.includes(
                                              toppingId
                                            ) && (
